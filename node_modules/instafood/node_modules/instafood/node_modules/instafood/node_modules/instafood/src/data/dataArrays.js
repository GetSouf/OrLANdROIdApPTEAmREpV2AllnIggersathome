...
export const recipes = [
  {
    ...
    categoryId: 3,
    title: 'VK',
    photo_url: 'https://static.vecteezy.com/system/resources/previews/014/018/584/non_2x/vk-logo-on-transparent-background-free-vector.jpg',
    photosArray: [
    ...
    description:
      'Длинный текст про приложение Длинный текст про приложение Длинный текст про приложение Длинный текст про приложение Длинный текст про приложение Длинный текст про приложение Длинный текст про приложение'
  },
  {
    recipeId: 3,
    categoryId: 3,
    title: 'INSTAGRAMM',
    photo_url:
      'https://img.freepik.com/premium-vector/instagram-app-icoon-social-media-logo-vector-illustratie_277909-403.jpg',
    photosArray: [
  ...
  },
  {
    ...
    categoryId: 1,
    title: 'Youtube',
    photo_url: 'https://thumbs.dreamstime.com/b/web-189206689.jpg',
    photosArray: [
  ...
  },
  {
    ...
    title: 'Telegramm',
    photo_url:
      'https://www.freepnglogos.com/uploads/telegram-logo-image-1.png',
    photosArray: [
  ...
  },
  {
    ...
    categoryId: 1,
    title: 'Яндекс еда',
    photo_url: 'https://miro.medium.com/max/1400/1*oisBf6xe0dvBq6Gu-Ucb9Q.png',
    photosArray: [
